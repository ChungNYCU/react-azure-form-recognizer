...
import GerneticInputFieldGenerator from './GerneticInputFieldGenerator'
...
const FormRecongnizerResultDisplay2 = (props) => {
...
export default FormRecongnizerResultDisplay2;
